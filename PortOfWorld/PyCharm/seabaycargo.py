...
xpath = '/html/body/div[3]/div[2]/div[1]/div[2]/div[2]/ul[1]/li[2]/table/tr/td/a/@href'
#         /html/body/div[3]/div[2]/div[1]/div[2]/div[2]/ul[2]/li[2]/table/tr/td[2]/a
#         /html/body/div[3]/div[2]/div[1]/div[2]/div[3]/ul[2]/li[1]/a
# xpath = '/html/body/div[3]/div[2]/div[1]/div[2]/div[2]/ul[2]/li[2]/table/tr/td/a/@href'
#        /html/body/div[3]/div[2]/div[1]/div[2]/div[2]/ul[2]/li[2]/table/tbody/tr/td[2]/a
...
for path in paths[0:]:
    page = HTTPRequestHTML(base_url + path)

    lst_ports = page.xpath(xpath_lst)
    print(len(lst_ports))
...
print(len(lst_name),len(lst_code),len(lst_type),len(lst_cate),len(lst_city),len(lst_link))
...
# ports_all.to_excel('seabaycargo-ports-global.xlsx')
